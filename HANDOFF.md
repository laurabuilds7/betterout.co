...
- **`src/pages/index.astro`** — product/ritual lead, **Free Guides moved to the bottom**; product is **"Available now"** with Order buttons (→ WhatsApp `wa.me/27630804439`, pre-filled order message); biohack-voice ritual copy; new founder quote; value-driven guides intro ("12+ years as a nutritionist…"); section colour rhythm (soft-sage hero, sand ritual, sage quote band, chocolate product, white guides).
